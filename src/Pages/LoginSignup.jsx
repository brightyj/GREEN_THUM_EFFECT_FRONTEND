...
const login = async () => {
  ...
  try {
      const response = await fetch('https://green-thumb-effect-backend.onrender.com/login', {
          method: 'POST',
          headers: {
...
const signup = async () => {
  ...
  try {
      const response = await fetch('https://green-thumb-effect-backend.onrender.com/signup', {
          method: 'POST',
          headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
